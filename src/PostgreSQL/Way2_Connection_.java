...
public class Way2_Connection_ {
    public static void main(String[] args) {
        try {
            //1st step: load the driver class
            Class.forName("org.postgresql.Driver");//create obj for class-internally it is using reflexion api
            //class.forname()-unchecked exception- so ClassNotFoundException is there
            //2nd step: establish connection
            Connection connection=DriverManager.getConnection("jdbc:postgresql://localhost:5431/practice?user=postgres && password=****");//this is a static query ?-task, what is sql injection ?
